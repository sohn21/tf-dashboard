...
export default async function Briefing() {
  ...
  return (
    <div className="briefing-wrap">
      ...
      <ExposureCard regime={data.summary.regime} regimeStatus={data.summary.regimeStatus} exposure={data.exposure} ftd={data.ftd} marketMetrics={data.marketMetrics} breadthPct={data.breadth?.above50emaPct} />
