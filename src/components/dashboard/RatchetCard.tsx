  ...
  return (
    <Card title="래칫 (Lock 래칫 실험 계좌)">
      <p className="ink-muted" style={{ marginTop: -4, marginBottom: 14 }}>
        코어·래더와 별도인 $10,000 계좌. 최대 4종목·종목당 25%(래더와 매수 방식 동일), -7% 손절 →
        +15%에서 스탑을 본전(BE)으로 → +25%부터 스탑을 단계적으로 상향(부분매도 없음, 전량 보유
        또는 전량 청산만). +100% 이상 찍은 런너는 스탑 이탈만으론 안 팔고 50일선 이탈과 동시에만 매도.
      </p>
      <StatRow columns={3}>
